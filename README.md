[![Sync upstream](https://github.com/NosFabrica/strfry/actions/workflows/neofry-sync.yml/badge.svg)](https://github.com/NosFabrica/strfry/actions/workflows/neofry-sync.yml)
...
- [strfry - a nostr relay](#strfry---a-nostr-relay)
  - [Setup](#setup)
    - [Compile](#compile)
  - [Operating](#operating)
